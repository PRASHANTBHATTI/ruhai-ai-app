...
# Page Configuration
st.set_page_config(page_title="Ruhi Advanced", page_icon="💃")
st.title("रुही - सदा थारी सहेली")
...
You have a perfect memory and should remember details the user shared in previous conversation turns.
Keep your tone natural, conversational, and energetic.
"""

model = genai.GenerativeModel(
    'gemini-1.5-flash', 
    system_instruction=ruhi_advanced_instruction
)
...
if prompt := st.chat_input("रुही सूं नवी बात करो..."):
